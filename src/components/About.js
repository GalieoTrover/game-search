...
const About = () => {
  ...
  return (
    <div>
      <Container className="about-cont" style={{ color: "white" }}>
        <div style={{ position: "relative", top: "100px" }}>
          <h4>Q. What is this website about?</h4>
          <p>
            A. This is one of my side projects mainly to learn front-end web
            development. The app shows data about the searched game title.
            Source code is available at the Github link.
          </p>
